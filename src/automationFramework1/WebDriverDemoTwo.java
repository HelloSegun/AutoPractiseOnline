...
public class WebDriverDemoTwo {
	...
	public static void main(String[] args) {
		...
		String overlayTitle = driver
				.findElement(By.cssSelector(
						"div.ui-dialog.ui-widget.ui-widget-content.ui-corner-all.dialogblue.dialogTop.searchPopupDialog.DialogOnTop.ui-draggable[role='dialog'] span#ui-id-4"))
				.getText();
		...
		// WebElement select =
		// driver.findElement(By.xpath("//*[@id='ddcl-selInd']/span/span"));
